...
<head>
    ...
    <title>Register Perkara | Data Personil</title>
...
<body class="fix-header fix-sidebar">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Personil</h3> </div>
                                  ...
                                  <div class="row">
                                      <div class="col-12">
                                        <div class="row">
                                          <div class="card">
                                              <div class="card-body">
                                                  <a href="<?php echo base_url(); ?>personil/form" type="button" class="btn btn-default bg-black c-white m-b-10 m-l-5">+ Tambah Data Personil</a>
                                                            ...
                                                            ?>
                                                              ...
                                                              <tr>
                                                                  ...
                                                                  <td>
                                                                        ...
                                                                        <a href="<?php echo base_url(); ?>personil/dataform/<?php echo $a->nrp ; ?>" type="button" class="btn btn-addon btn-sm btn-primary btn-rounded m-b-10 m-l-5"><i class="ti-pencil"></i> Edit</a>



                                                                        <a href="javascript:void(0) ;" onclick="hapus(<?php echo $a->nrp;?>) ;" type="button" class="btn btn-addon btn-sm btn-danger sweet-confirm btn-rounded m-b-10 m-l-5"><i class="ti-trash"></i> Hapus</a>
    ...
    function hapus(id){
       var r=confirm("Apakah anda yakin akan menghapus data tersebut ?")
        if (r==true)
          window.location = url+"personil/deldata/"+id;
        else
          return false;
        } 
    </script>
