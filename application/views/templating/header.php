                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>usermanagement"><i class="ti-settings"></i> Manajemen User</a></li>
                                    <li><a href="<?php echo base_url(); ?>login/goodbye"><i class="fa fa-power-off"></i> Keluar</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
