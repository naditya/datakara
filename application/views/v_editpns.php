        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Tambah Personil</h3> </div>
                                    ...
                                    <div class="p-20">
                                        ...
                                        <div class="form-validation">
                                              ...
                                              <?php
                                                    ...
                                                    echo form_open('pns/editdata', $attributes);

                                              ?>
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-nrp">NIP <span class="text-danger">*</span></label>
                                                    <div class="col-lg-8">
                                                        <input type="text" class="form-control" id="val-username" name="val-username" value="<?php echo $p->nip ; ?>" disabled>
                                                         <input type="hidden" class="form-control" id="val-nrp" name="val-nrp" value="<?php echo $p->nip ; ?>">
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <select class="form-control" id="val-pangkat" name="val-pangkat">
                                                            <option value="<?php foreach ($resultgolpang as $pang) { echo $pang->id_pangpns; ?>" selected hidden> <?php echo $pang->jenis_pangpns; echo " - "; echo $pang->nama_pangpns; }?></option>
                                                            <?php
                                                            
                                                                foreach ($golpang as $papns) {

                                                            ?>
                                                            <option value="<?php echo $papns->id_pangpns; ?>">
                                                            <?php 
                                                                echo $papns->jenis_pangpns;
                                                                echo " - ";
                                                                echo $papns->nama_pangpns;
                                                            ?>
                                                            </option>
                                                                <?php } ?>
                                                        </select>
