                                    ...
                                    <div class="p-20">
                                        ...
                                        <div class="form-validation">
                                              ...
                                              <?php
                                                  ...
                                                  echo form_open('pangkat/addpangkat', $attributes);

                                              ?>
                                                <div class="form-group row">

                                                    <label class="col-lg-4 col-form-label" for="val-username">Matra <span class="text-danger">*</span></label>
                                                    <div class="col-lg-8">
                                                    
                                                        <select class="form-control" id="val-jenis" name="val-jenis">
                                                            <option value="" selected disabled hidden> Pilih Matra </option>
                                                            <?php
                                                    ...
                                                    <label class="col-lg-4 col-form-label" for="val-jenis">Nama Pangkat/Gol <span class="text-danger">*</span></label>
                                                    <div class="col-lg-8">
                                                     
                                                         <input type="text" class="form-control" id="val-username" name="val-username" placeholder="Inputkan Pangkat/Gol...">
