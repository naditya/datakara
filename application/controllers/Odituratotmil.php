...
class Odituratotmil extends CI_Controller {
	...
	function render_page_topadmin($content, $data = NULL){
        ...
        $this->load->view('v_odituratotmil', $data);
    }
	...
	function render_page_topadmin_add($content, $data = NULL){
        ...
        $this->load->view('v_tambahodituratotmil', $data);
    }
	...
	function render_page_topadmin_edit($content, $data = NULL){
        ...
        $this->load->view('v_editodituratotmil', $data);
    }
	...
	public function index() {
		...
		if ($this->session->userdata('status') == "login" && $this->session->userdata('role') == "topadmin" ) {
			$table='odituratotmil';
			$data['odituratotmil'] = $this->model_crud->get_data($table)->result();
			$this->render_page_topadmin('v_odituratotmil', $data);
		}
	...
	public function form() {
		...
		if ($this->session->userdata('status') == "login" && $this->session->userdata('role') == "topadmin" ) {
			//$table1='odituratotmilti';
			//$data['otmilti'] = $this->model_crud->get_data($table1)->result();
			$this->render_page_topadmin_add('v_tambahodituratotmil', $data);
		}
		if ($this->session->userdata('status') == "login" && $this->session->userdata('role') == "admin" ) {
			$this->render_page_admin('a_dashboard');
		}
	...
	public function addodituratotmil(){
		if($this->session->userdata('status') != "login"){
			$this->load->view('v_login');
		}
		if ($this->session->userdata('status') == "login" && $this->session->userdata('role') == "topadmin" ) {
			...
			$data=array(
				'id_odituratotmil'=>'',
				'nama_odituratotmil'=>$this->input->post('val-username')
			);
			...
			//$data['odituratotmil'] = $this->model_crud->view_data($table)->result();
			//$this->render_page_topadmin('v_odituratotmil', $data);
			redirect('odituratotmil');
		}
		if ($this->session->userdata('status') == "login" && $this->session->userdata('role') == "admin" ) {
			$this->render_page_admin('a_dashboard');
		}
	...
	public function dataform($uptome) {
		...
		if ($this->session->userdata('status') == "login" && $this->session->userdata('role') == "topadmin" ) {
			...
			//echo "<br> $id";
			$where = array('id_odituratotmil' => $uptome);
			$table = 'odituratotmil';
			//$data['odituratotmil'] = $this->model_crud->getbyid($where,$table)->result();
			$data['odituratotmil'] = $this->model_crud->getbyid($where,$table)->result();
			//$table1='odituratotmilti';
			//$data['otmilti'] = $this->model_crud->get_data($table1)->result();
			$this->render_page_topadmin_edit('v_editodituratotmil', $data);
		}
		if ($this->session->userdata('status') == "login" && $this->session->userdata('role') == "admin" ) {
			$this->render_page_admin('a_dashboard');
		}
	...
	function editdata(){
		...
		if ($this->session->userdata('status') == "login" && $this->session->userdata('role') == "topadmin" ) {
			...
			$namaodituratotmil = $this->input->post('val-username');
			$namaodituratotmilti = $this->input->post('val-jenis');
			
		 
			$data = array(
				'nama_odituratotmil' => $namaodituratotmil
			);
	...
	public function deldata($id) {
		...
		if ($this->session->userdata('status') == "login" && $this->session->userdata('role') == "topadmin" ) {
			$where = array('id_odituratotmil' => $id);
			$table='odituratotmil';
