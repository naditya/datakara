...
class Odituratotmilti extends CI_Controller {
	...
	function render_page_topadmin($content, $data = NULL){
        ...
        $this->load->view('v_odituratotmilti', $data);
    }
	...
	function render_page_topadmin_add($content, $data = NULL){
        ...
        $this->load->view('v_tambahodituratotmilti', $data);
    }
	...
	function render_page_topadmin_edit($content, $data = NULL){
        ...
        $this->load->view('v_editodituratotmilti', $data);
    }
	...
	public function form() {
		...
		if ($this->session->userdata('status') == "login" && $this->session->userdata('role') == "topadmin" ) {
			$this->render_page_topadmin_add('v_tambahodituratotmilti');
		}
		if ($this->session->userdata('status') == "login" && $this->session->userdata('role') == "admin" ) {
			$this->render_page_admin('a_dashboard');
		}
	...
	public function addodituratotmilti(){
		if($this->session->userdata('status') != "login"){
			$this->load->view('v_login');
		}
		if ($this->session->userdata('status') == "login" && $this->session->userdata('role') == "topadmin" ) {
			...
			$data=array(
				'id_odituratotmilti'=>'',
				'nama_odituratotmilti'=>$this->input->post('val-username')
			);
	...
	public function dataform($uptome) {
		...
		if ($this->session->userdata('status') == "login" && $this->session->userdata('role') == "topadmin" ) {
			...
			//echo "<br> $id";
			$where = array('id_odituratotmilti' => $uptome);
			$table = 'odituratotmilti';
			$data['odituratotmilti'] = $this->model_crud->getbyid($where,$table)->result();
			$this->render_page_topadmin_edit('v_editodituratotmilti', $data);
		}
		if ($this->session->userdata('status') == "login" && $this->session->userdata('role') == "admin" ) {
			$this->render_page_admin('a_dashboard');
		}
	...
	function editdata(){
		...
		if ($this->session->userdata('status') == "login" && $this->session->userdata('role') == "topadmin" ) {
			...
			$namaodituratotmilti = $this->input->post('val-username');
			
		 
			$data = array(
				'nama_odituratotmilti' => $namaodituratotmilti
			);
		 
			$where = array(
				'id_odituratotmilti' => $id
			);
	...
	public function deldata($id) {
		...
		if ($this->session->userdata('status') == "login" && $this->session->userdata('role') == "topadmin" ) {
			$where = array('id_odituratotmilti' => $id);
			$table='odituratotmilti';
