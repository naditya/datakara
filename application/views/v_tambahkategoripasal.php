                                    ...
                                    <div class="p-20">
                                        ...
                                        <div class="form-validation">
                                              ...
                                              <?php
                                                  ...
                                                  echo form_open('kategoripasal/addkategoripasal', $attributes);
                                              ...
                                              ?>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <input type="text" class="form-control" id="val-username" name="val-username" placeholder="Inputkan Kategori Pasal...">
                                                    </div>
                                                </div>
