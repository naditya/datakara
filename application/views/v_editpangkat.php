                                        ...
                                        <div class="form-validation">
                                              ...
                                              <?php
											   foreach($pangkat as $u){
                                                  ...
                                                  echo form_open('pangkat/editdata/', $attributes);

                                              ?>
                                                <div class="form-group row">

                                                    <label class="col-lg-4 col-form-label" for="val-jenis">Matra <span class="text-danger">*</span></label>
                                                    <div class="col-lg-8">
														 <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $u->id_pangkat ?>" >
														<select class="form-control" id="val-jenis" name="val-jenis">
															<option value="<?php echo $u->id_matra ; ?>" selected hidden> <?php echo $u->nama_matra ; ?> </option>
															<?php
															
                                                                foreach ($matra as $a) {

                                                            ?>
															<option value="<?php echo $a->id_matra ; ?>">
															<?php 
																echo $a->nama_matra ;
															?>
															</option>
													...
													<label class="col-lg-4 col-form-label" for="val-jenis">Nama Pangkat <span class="text-danger">*</span></label>
                                                    <div class="col-lg-8">
														<input type="text" class="form-control" id="val-username" name="val-username" value="<?php echo $u->nama_pangkat ?>" >
