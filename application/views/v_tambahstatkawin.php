                                    ...
                                    <div class="p-20">
                                        ...
                                        <div class="form-validation">
                                              ...
                                              <?php
                                                  ...
                                                  echo form_open('statkawin/addstatkawin', $attributes);
                                              ...
                                              ?>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <input type="text" class="form-control" id="val-username" name="val-username" placeholder="Inputkan status perkawinan...">
                                                    </div>
                                                </div>
