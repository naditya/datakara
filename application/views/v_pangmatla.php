...
<body class="fix-header fix-sidebar">
                            ...
                            <div class="tab-content">
                                  <div class="row">
                                      <div class="col-12">
                                          <div class="card">
                                              <div class="card-body">
                                                  <a href="<?php echo base_url(); ?>pangmatla/form" type="button" class="btn  btn-default bg-black c-white  m-b-10 m-l-5">+ Tambah Data Pangkat Matra Laut</a>
                                                  ...
                                                  <div class="table-responsive m-t-40">
                                                     <table id="example23" class="display nowrap table table-hover table-bordered" cellspacing="0" width="100%">
                                                          ...
                                                          <tbody>
                                                            <?php
                                                                $no=1;
                                                                foreach ($pangmatla as $a) {

                                                            ?>

                                                              <tr>
                                                                  <td><?php echo $no++ ?></td>
                                                                  <td><?php echo $a->nama_pangmatla ?></td>
                                                                  <td>
                                                                    
                                                                        <a href="<?php echo base_url(); ?>pangmatla/dataform/<?php echo $a->id_pangmatla ; ?>" type="button" class="btn btn-addon btn-sm btn-primary btn-rounded m-b-10 m-l-5"><i class="ti-pencil"></i> Edit</a>



                                                                        <a href="javascript:void(0) ;" onclick="hapus(<?php echo $a->id_pangmatla ; ?>) ;" type="button" class="btn btn-addon btn-sm btn-danger sweet-confirm btn-rounded m-b-10 m-l-5"><i class="ti-trash"></i> Hapus</a>
    ...
    function hapus(id){
       var r=confirm("Apakah anda yakin akan menghapus data tersebut ?")
        if (r==true)
          window.location = url+"pangmatla/deldata/"+id;
        else
          return false;
        } 
    </script>
