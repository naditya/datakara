                                    ...
                                    <div class="p-20">
                                        ...
                                        <div class="form-validation">
                                              ...
                                              <?php
                                                  ...
                                                  echo form_open('personil/addpersonil', $attributes);
                                              ...
                                              ?>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
														 ...
														 <input type="text" class="form-control" id="val-nrp" name="val-nrp" placeholder="Inputkan NRP ...">
                                                    ...
                                                    <div class="col-lg-8">
														 ...
														 <input type="text" class="form-control" id="val-korps" name="val-korps" placeholder="Inputkan Korps ...">
