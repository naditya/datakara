        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Kontrol Akses</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Kontrol Akses</a></li>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body p-b-0">
                            <h4 class="card-title">Kontrol Akses</h4>
                                        ...
                                        <div class="form-validation">
                                              ...
                                              <?php
											   foreach($akses as $u){
                                                  ...
                                                  echo form_open('akses/editdata/', $attributes);

                                              ?>
                                                <div class="form-group row">

                                                    <label class="col-lg-4 col-form-label" for="val-username">Nama Akses <span class="text-danger">*</span></label>
                                                    <div class="col-lg-8">
														 <input type="hidden" class="form-control" id="val-id" name="val-id" value="<?php echo $u->nama_akses ?>" >
                                                        <input type="text" class="form-control" id="val-username" name="val-username" value="<?php echo $u->nama_akses ?>" disabled >
                                                    </div>
													
													<label class="col-lg-4 col-form-label" for="val-nama">Oditurat <span class="text-danger">*</span></label>
                                                    <div class="col-lg-8">
														 
                                                        <input type="text" class="form-control" id="val-nama" name="val-nama" value="<?php echo $u->oditurat ?>" >
                                                    </div>
                                                </div>
