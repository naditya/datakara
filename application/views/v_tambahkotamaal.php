                                    ...
                                    <div class="p-20">
                                        ...
                                        <div class="form-validation">
                                              ...
                                              <?php
                                                  ...
                                                  echo form_open('kotamaal/addkotamaal', $attributes);

                                              ?>
                                                <div class="form-group row">

                                                    <label class="col-lg-4 col-form-label" for="val-username">Kotama TNI AL <span class="text-danger">*</span></label>
                                                    <div class="col-lg-8">
                                                     
                                                        <input type="text" class="form-control" id="val-username" name="val-username" placeholder="Inputkan Kotama TNI AL...">
                                                    </div>
                                                </div>
