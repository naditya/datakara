                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="p-20">
                                        ...
                                        <div class="form-validation">
                                              ...
                                              <?php
                                               foreach($pangpns as $u){
                                                  $attributes = array('class' => 'form-valide');
                                                  echo form_open('pangpns/editdata/', $attributes);

                                              ?>
                                                <div class="form-group row">

                                                    <label class="col-lg-4 col-form-label" for="val-username">Pangkat PNS <span class="text-danger">*</span></label>
                                                    <div class="col-lg-8">
                                                         <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $u->id_pangpns ?>" >
                                                         <input type="text" class="form-control" id="val-jenis" name="val-jenis" value="<?php echo $u->jenis_pangpns ?>" >
                                                        
                                                    </div>
                                                    
                                                     <label class="col-lg-4 col-form-label" for="val-username"></label>
                                                    <div class="col-lg-8">
                                                         
                                                        <input type="text" class="form-control" id="val-username" name="val-username" value="<?php echo $u->nama_pangpns ?>" >
                                                    </div>
                                                </div>
