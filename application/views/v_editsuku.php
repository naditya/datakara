                                        ...
                                        <div class="form-validation">
                                              ...
                                              <?php
											   foreach($suku as $u){
                                                  ...
                                                  echo form_open('suku/editdata/', $attributes);

                                              ?>
                                                <div class="form-group row">

                                                    <label class="col-lg-4 col-form-label" for="val-username">suku <span class="text-danger">*</span></label>
                                                    <div class="col-lg-8">
														 <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $u->id_suku ?>" >
                                                        <input type="text" class="form-control" id="val-username" name="val-username" value="<?php echo $u->nama_suku ?>" >
                                                    </div>
                                                </div>
