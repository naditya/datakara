                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="p-20">
                                        ...
                                        <div class="form-validation">
                                              ...
                                              <?php
                                               foreach($odituratotjen as $u){
                                                  $attributes = array('class' => 'form-valide');
                                                  echo form_open('odituratotjen/editdata/', $attributes);

                                              ?>
                                                <div class="form-group row">

                                                    <label class="col-lg-4 col-form-label" for="val-username">Otjen <span class="text-danger">*</span></label>
                                                    <div class="col-lg-8">
                                                         <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $u->id_odituratotjen ?>" >
                                                        <input type="text" class="form-control" id="val-username" name="val-username" value="<?php echo $u->nama_odituratotjen ?>" >
                                                    </div>
                                                </div>
