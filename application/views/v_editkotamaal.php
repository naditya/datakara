                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="p-20">
                                        ...
                                        <div class="form-validation">
                                              ...
                                              <?php
											   foreach($kotamaal as $u){
                                                  $attributes = array('class' => 'form-valide');
                                                  echo form_open('kotamaal/editdata/', $attributes);
                                              ...
                                              ?>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
														 <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $u->id_kotamaal ?>" >
                                                        <input type="text" class="form-control" id="val-username" name="val-username" value="<?php echo $u->nama_kotamaal ?>" >
                                                    </div>
                                                </div>
