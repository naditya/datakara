                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="p-20">
                                        ...
                                        <div class="form-validation">
                                              ...
                                              <?php
                                               foreach($pangmatud as $u){
                                                  $attributes = array('class' => 'form-valide');
                                                  echo form_open('pangmatud/editdata/', $attributes);

                                              ?>
                                                <div class="form-group row">

                                                    <label class="col-lg-4 col-form-label" for="val-username">Pangkat Matra Udara <span class="text-danger">*</span></label>
                                                    <div class="col-lg-8">
                                                         <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $u->id_pangmatud ?>" >
                                                        <input type="text" class="form-control" id="val-username" name="val-username" value="<?php echo $u->nama_pangmatud ?>" >
                                                    </div>
                                                </div>
