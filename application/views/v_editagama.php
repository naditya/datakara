                                        ...
                                        <div class="form-validation">
                                              ...
                                              <?php
                                               foreach($agama as $u){
                                                  ...
                                                  echo form_open('agama/editdata/', $attributes);
                                              ...
                                              ?>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                         <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $u->id_agama ?>" >
                                                        <input type="text" class="form-control" id="val-username" name="val-username" value="<?php echo $u->nama_agama ?>" >
                                                    </div>
                                                </div>
