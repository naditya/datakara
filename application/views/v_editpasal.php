...
<head>
    ...
    <title>Register Perkara | Pasal</title>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Pasal</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Master Data</a></li>
                        <li class="breadcrumb-item active">Pasal</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body p-b-0">
                            <h4 class="card-title">Master Data [ Pasal ]</h4>
                                        ...
                                        <div class="form-validation">
                                              ...
                                              <?php
                                               foreach($pasal as $u){
                                                  ...
                                                  echo form_open('pasal/editdata/', $attributes);

                                              ?>
                                                <div class="form-group row">
                                                    
                                                    <label class="col-lg-4 col-form-label" for="val-jenis">Kategori <span class="text-danger">*</span></label>
                                                    <div class="col-lg-8">
                                                     
                                                        
                                                        <select class="form-control" id="val-jenis" name="val-jenis">
                                                            <option value="<?php echo $u->id_kategoripasal ; ?>" selected hidden><?php echo $u->nama_kategoripasal ; ?> </option>
                                                            <?php
                                                            
                                                                foreach ($kategoripasal as $a) {

                                                            ?>
                                                            <option value="<?php echo $a->id_kategoripasal ; ?>">
                                                            <?php 
                                                                echo $a->nama_kategoripasal ;
                                                            ?>
                                                            </option>
                                                                <?php } ?>
                                                        </select>
                                                    ...
                                                    <label class="col-lg-4 col-form-label" for="val-username">Pasal <span class="text-danger">*</span></label>
                                                    <div class="col-lg-8">
                                                         <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $u->id_pasal ?>" >
                                                        <input type="text" class="form-control" id="val-username" name="val-username" value="<?php echo $u->nama_pasal ; ?>">
                                                    </div>
                                                    
                                                    <label class="col-lg-4 col-form-label" for="val-tlp">Ayat <span class="text-danger">*</span></label>
                                                    <div class="col-lg-8">
                                                     
                                                        <input type="text" class="form-control" id="val-tlp" name="val-tlp" value="<?php echo $u->nama_ayat ; ?>">
                                                    </div>
                                                    
                                                    <label class="col-lg-4 col-form-label" for="val-alamat">Klasifikasi <span class="text-danger">*</span></label>
                                                    <div class="col-lg-8">
                                                     
                                                        <input type="text" class="form-control" id="val-alamat" name="val-alamat" value="<?php echo $u->nama_klasifikasi ; ?>"></input>
                                                    </div>
