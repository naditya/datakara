                                    ...
                                    <div class="p-20">
                                        ...
                                        <div class="form-validation">
                                              ...
                                              <?php
                                                  ...
                                                  echo form_open('akses/addakses', $attributes);
                                              ...
                                              ?>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <input type="text" class="form-control" id="val-username" name="val-username" placeholder="Inputkan Akses...">
                                                    </div>
                                                    
                                                     <label class="col-lg-4 col-form-label" for="val-nama">Oditurat <span class="text-danger">*</span></label>
                                                    <div class="col-lg-8">
                                                     
                                                        <input type="text" class="form-control" id="val-nama" name="val-nama" placeholder="Inputkan Oditurat...">
                                                    </div>
                                                </div>
